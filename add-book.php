...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (addBook($data)) {
        $message = displayMessage('Book added successfully!');
    } else {
        $error = displayMessage('Failed to add book. Please try again.', 'danger');
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="isbn" class="form-label">ISBN <span class="text-muted">(Optional)</span></label>
